    ...
    constructor(
        ...
        this.subscribers = this.ds.dataStore$.subscribe(res => {
            ...
            if (_.get(res.company_transactions.details, "data", null)) {
                this.companyTranscations =
                    res.company_transactions.details.data;
            }

            if (_.get(res.claims_txns.details, "data", null)) {
                this.claimsData = res.claims_txns.details.data;

                this.pendingClaimsData = _.filter(this.claimsData, function(
                    claims
                ) {
                ...
                this.rejectedClaimsData = _.filter(this.claimsData, function(
                    claims
                ) {
                ...
                this.settledClaimsData = _.filter(this.claimsData, function(
                    claims
                ) {
                    if (
                ...
                this.settledClaims = this.getSettledClaimAmount(
                    this.settledClaimsData
                );
            }
