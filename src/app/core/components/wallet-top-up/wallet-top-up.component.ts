   ...
   {value: 'Retailer-2', viewValue: 'Retailer3'},
    ...
    constructor(
        ...
        this.subscribers = this.ds.dataStore$.subscribe(res => {
            ...
            if (_.get(res.transcationAddResponse.details, "data", null)) {
                this.transcationAddResponse =
                    res.transcationAddResponse.details.data;
    ...
    payWithRazor(val) {
        ...
        const options: any = {
            ...
            amount:
                this.validateOnlineForm.controls["onlineAmount"].value * 100, // amount should be in paise format to display Rs 1255 without decimal point
            currency: "INR",
    ...
    submitForm(): void {
        ...
        if (this.validateForm.valid) {
            ...
            let payload = {
                ...
                company: this.company_id,
                details: {
                    transaction_id: this.validateForm.controls["transactionNo"]
                        .value,
